...
Queue_Adapter<T, QUEUE>::Queue_Adapter (size_t size) : queue_(QUEUE(size))
{
}
...
// Copy constructor.
template <typename T, typename QUEUE>
Queue_Adapter<T, QUEUE>::Queue_Adapter (const Queue_Adapter<T, QUEUE> &rhs) : queue_(rhs.queue_)
{
}
